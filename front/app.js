// ============================================================
// Front - Óptica La Mirada (Clase 12)
// Sin novedades del lado del front: la clase de hoy vive en el
// backend (middleware de errores + logs). Fijate igual cómo el
// front APROVECHA los mensajes claros que devuelve la API.
// ============================================================
