// ============================================================
// Middleware de registro (estándar desde la C08), MEJORADO hoy:
// además de la consola, cada petición queda en logs/acceso.log.
// Un backend profesional deja rastro de todo lo que atendió.
// ============================================================
const fs = require("fs");
