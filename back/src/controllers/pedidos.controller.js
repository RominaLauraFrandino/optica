// ============================================================
// CAPA DE CONTROLADORES - Óptica La Mirada
// MIRÁ LO QUE FALTA: ¡no hay ningún try/catch!
// Cada controlador va envuelto en asyncHandler (en las rutas):
// si algo falla, el error viaja solo hasta el middleware
// centralizado de errores.js. Comparalo con el controlador de
// la Clase 11: misma funcionalidad, la mitad del código.
// ============================================================
